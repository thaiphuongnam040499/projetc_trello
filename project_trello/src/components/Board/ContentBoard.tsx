  ...
  return (
    <div className="ms-5 w-100">
      ...
      <div className="content-ws">
        ...
        <div className="scrollbar scrollbar-indigo bordered-indigo thin w-100 content-board">
                    ...
                    <div key={workingSpace.id} className="history mt-4">
                      <div className="d-flex align-items-center justify-content-between ">
                        ...
                        <div className="d-flex">
                          ...
                          <button className="btn btn-light border rounded me-2 btn-ws">
                            <i className="bi bi-columns-gap me-2 fs-6"></i>Dạng
                            xem
                          </button>
                          <FormCreateMemberWs
                          ...
                          <div className="dropdown">
                            <button
                              ...
                              aria-expanded="false"
                            >
                              <i className="bi bi-gear-wide me-2 fs-6"></i>Cài
                              đặt
                            </button>
                            <ul
